...
- Azure production revision: `ca-anyrouters-web--gemini3637-2`
- Azure production image: `acranyroutersprod.azurecr.io/new-api:gemini-36-37-5114489-20260826`
...
3. AWS Claude and Azure GPT channels are preserved; Gemini/Vertex uses the retained Jiaxuan GCP project `anyrouters-prod`.
...
5. Restored the Vertex channel to Jiaxuan project `anyrouters-prod`, archived the paused Kongshiai credential, and preserved AWS and Azure channels.
...
10. Published Gemini 3.6/3.7, rebuilt the channel ability index (5 succeeded, 0 failed), and repeated the complete production provider smoke test.
...
- Final Gemini 3.6/3.7 production catalog/provider smoke: `job-anyrouters-api-smoke-k97gm68` — Succeeded
